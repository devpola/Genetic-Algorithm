...
def single_poing_crossover(a: Genome, b: Genome) -> Tuple[Genome, Genome]:
    if len(a) != len(b):
...
def run_evolution(
    ...
    crossover_func: CrossoverFunc = single_poing_crossover,
    ...
    for i in range(generation_limit):
        ...
        next_generation = population[0:2]   # keep top 2 genome for next generation
